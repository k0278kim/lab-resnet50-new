...
train_dataset = datasets.ImageFolder("/data/imagenet/train", split='train', download=None, transform=transform)
train_loader = DataLoader(train_dataset, batch_size=BATCH_SIZE, shuffle=True)

# 테스트 데이터셋
test_dataset = datasets.ImageFolder("/data/imagenet/val", split='val', download=None, transform=transform)
